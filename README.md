...
### 学习内容：本次学习包括小程序项目建立流程，全局配置，基本语法（数据渲染、事件绑定、wxss样式、wxs辅助语法、生命周期、数据请求、weui组件库、微信小程序自带组件库、自定义组件、页面跳转方式）

### appId：wx3baa62d226bd1f99
### cloud环境id：cloud1-3grnvsv94a3d9683
